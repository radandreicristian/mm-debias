# Source: https://github.com/felifri/MAGBIG/blob/main/generate_evaluate/utils_debias.py
...
def get_img_list(loc, occ, args, exp=0, images_path_postfix=''):
    img_list = []
    ...
    if loc == "laion":
        ...
        generated_images_path = "generated_images" if images_path_postfix == '' else f"generated_images_{images_path_postfix}"
        if not args.language:
            img_path = f"data/eval/{generated_images_path}/{args.model}_{args.model_version}/{loc}/{occ}"
        else:
            if not args.gender_neutral:
                img_path = f"data/eval/{generated_images_path}/multiling/{args.model}_{args.model_version}/{args.language}/{loc}/{occ}"
            else:
                img_path = f"data/eval/{generated_images_path}/multiling/gender_neutral/{args.model}_{args.model_version}/{args.language}/{loc}/{occ}"
