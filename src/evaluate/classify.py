# Source: https://github.com/felifri/MAGBIG/blob/main/generate_evaluate/classify_images.py

import pandas as pd
from src.evaluate.utils import detect_face, predict_age_gender_race, ensure_dir, classify_w_clip, get_img_list
import dlib
import argparse
import clip
import torch
