...
def parse_args():
    ...
    if args.train_data_dir is None:
        raise ValueError("Need training folder.")
...
def main():
    ...
    if accelerator.is_main_process:
        ...
        plt.savefig(f'{args.output_dir}/finetuning_loss.jpg', bbox_inches='tight')
    ...
    if accelerator.is_main_process:
        ...
        model_index_path = os.path.join(args.output_dir, "model_index.json")

        #correct the text_encoder type
