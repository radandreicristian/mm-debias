...
RUN pip install numpy==1.22.0 pillow==10.4.0 dlib==19.24.5 diffusers==0.13.0 transformers==4.44.0 accelerate python-dotenv sacremoses simalign stanza clip-anytorch sentencepiece
